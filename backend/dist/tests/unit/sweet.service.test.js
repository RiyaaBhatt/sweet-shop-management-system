...
describe("SweetService", () => {
    ...
    describe("updateSweet", () => {
        ...
        it("should throw error if sweet not found", async () => {
            ...
            await expect(sweetService.updateSweet(sweetId, updateData)).rejects.toThrow("Sweet not found");
        });
    ...
    describe("deleteSweet", () => {
        ...
        it("should throw error if sweet not found", async () => {
            ...
            await expect(sweetService.deleteSweet(sweetId)).rejects.toThrow("Sweet not found");
        });
        it("should delete the sweet", async () => {
            ...
            prisma.sweet.findUnique.mockResolvedValue(existingSweet);
            prisma.sweet.delete.mockResolvedValue(existingSweet);
    ...
    describe("purchaseSweet", () => {
        ...
        it("should throw error if sweet not found", async () => {
            prisma.sweet.findUnique.mockResolvedValue(null);
            await expect(sweetService.purchaseSweet(sweetId, userId, quantity)).rejects.toThrow("Sweet not found");
        });
        it("should throw error if insufficient quantity", async () => {
            ...
            await expect(sweetService.purchaseSweet(sweetId, userId, quantity)).rejects.toThrow("Insufficient quantity available");
        });
        it("should process purchase successfully", async () => {
            ...
            const result = await sweetService.purchaseSweet(sweetId, userId, quantity);
    ...
    describe("restockSweet", () => {
        ...
        it("should throw error if sweet not found", async () => {
            prisma.sweet.findUnique.mockResolvedValue(null);
            await expect(sweetService.restockSweet(sweetId, userId, quantity)).rejects.toThrow("Sweet not found");
        });
        it("should process restock successfully", async () => {
            ...
            prisma.sweet.update.mockResolvedValue(updatedSweet);
