...
import { register, login, refresh, logout, revoke, } from "../controllers/auth.controller";
import { authenticate } from "../middlewares/auth.middleware";
import { loginLimiter, registerLimiter, refreshLimiter, securityLimiter, } from "../middlewares/rate-limit.middleware";
const router = Router();
